...
const sampleRecommendations: Recommendation[] = [
  {
    ...
    comment: 'This movie is absolutely incredible! Heath Ledger as Joker is unforgettable.',
    likes: 234,
    replies: 45,
  ...
  },
  {
    ...
    type: 'music',
    recommendationTier: 'highly',
    comment: 'This song gives me so much energy! Perfect for workouts.',
    likes: 189,
    replies: 23,
...
export default function SocialRecommendations({ onViewDetails }: SocialRecommendationsProps) {
    ...
    <div className="mb-8">
      ...
      <div className="space-y-4 px-4">
        {recommendations.map((rec) => {
          ...
          return (
            <div key={rec.id} className={`bg-gray-800/50 rounded-xl p-4 border-2 ${tier.color.replace('text-', 'border-')} hover:border-teal-500/50 transition cursor-pointer`}
                 onClick={() => onViewDetails && onViewDetails({ title: rec.title, type: rec.type })}>
              <div className="flex gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-4">
                    <button onClick={(e) => { e.stopPropagation(); handleLike(rec.id); }} 
